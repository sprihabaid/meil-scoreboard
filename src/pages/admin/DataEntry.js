...
const FIELDS = [
  ...
  { key: 'winback_clients',        label: 'Win-Back Clients',      unit: '',     step: '1',      ph: 'e.g. 1'      },
  { key: 'retention_count',        label: 'Clients Retained',      unit: '',     step: '1',      ph: 'e.g. 5'      },
  { key: 'total_clients',          label: 'Total Active Clients',  unit: '',     step: '1',      ph: 'e.g. 10'     },
